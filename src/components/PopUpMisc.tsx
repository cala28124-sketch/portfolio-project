  ...
  return (
    <>
      ...
      <div className="flex justify-center">
        <div
          id="misc"
          className={`my-4 font opacity-0 absolute my-4 flex flex-col h-4/5 w-7xl items-center rounded-md border-10 border-green-800 bg-green-300 z-50 overflow-y-auto 
    ${isOpen ? "start pointer-events-auto" : "pointer-events-none"}`}
        >
          ...
          <p className="font-bold text-green-800 text-5xl p-2">Featured</p>
